...
class AppColors {
  ...
  static const Color operativo = Color(0xFF6FCF97); // verde menta pastel (texto/ícono)
  static const Color operativoBg = Color(0xFFE3F7EA); // fondo suave
  static const Color falla = Color(0xFFE8828C); // coral pastel (texto/ícono)
  static const Color fallaBg = Color(0xFFFBE7E9); // fondo suave
